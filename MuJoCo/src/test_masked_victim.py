...
if __name__ == "__main__":
    ...
    # YouShallNotPass
    # p.add_argument("--opp-path", default="../adv-agent/ucb_attack/you/model.npy", type=str)
    ...
    # p.add_argument("--norm_path", default="../adv-agent/ucb_attack/you/obs_rms.pkl", type=str)

    # KickAndDefend
    # p.add_argument("--opp-path", default="../adv-agent/ucb_attack/kick/model.npy", type=str)
    ...
    # p.add_argument("--norm_path", default="../adv-agent/ucb_attack/kick/obs_rms.pkl", type=str)

    # SumoHumans
    p.add_argument("--opp-path", default="../adv-agent/ucb_attack/humans/model.pkl", type=str)
    p.add_argument("--vic_path", default="../multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v3.pkl", type=str)
    p.add_argument("--vic_id", default=0, type=int)
    p.add_argument("--norm_path", default="../adv-agent/ucb_attack/humans/obs_rms.pkl", type=str)

    # SumoAnts
    # p.add_argument("--opp-path", default="../adv-agent/ucb_attack/ants/model.npy", type=str)
    # p.add_argument("--vic_path", default="../multiagent-competition/agent-zoo/sumo/ants/agent_parameters-v1.pkl", type=str)
    # p.add_argument("--vic_id", default=0, type=int)
    # p.add_argument("--norm_path", default="../adv-agent/ucb_attack/ants/obs_rms.pkl", type=str)
