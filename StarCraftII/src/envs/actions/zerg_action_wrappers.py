...
class ZergActionWrapper(gym.Wrapper):
    ...
    def __init__(self, env, game_version='4.1.2', mask=False,
        ...
        self._dc = DataContext() # perform unit action based on the current observation.
...
class ZergPlayerActionWrapper(ZergActionWrapper):
    """
    action wrapper, receive macro actions and perform the corresponding unit actions.
    """
