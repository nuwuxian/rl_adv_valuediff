...
from s2clientprotocol import sc2api_pb2 as sc_pb # base action sc_pb.Action()
...
class BuildActions(object):
    """
    Represents all 13 building macro actions, each of which builds a certain Zerg building. When executed, it will
    conducts a series of unit actions and randomly makes some trivial decisions, according to the prior knowledge
    (tech_tree).
    """
    def __init__(self, game_version='4.1.2'):
        """
        :param game_version: version of the starcraft game.
        """
        self._placer = Placer()
    ...
    def action(self, func_name, type_id):
        ...
        :param type_id: the id of the building function 1-13.
        :return: a function name tuple.
        """
    ...
    def _build_unit(self, type_id):
        """
        prepare the action functions for a macro action.
        :param type_id: the id of this building macro action.
        :return: actions function takes dc as an input.
        """
    ...
    def _is_valid_build_unit(self, type_id):
        """
        check the tech_tree rule.
        :param type_id: the id of this building macro action.
        :return: check valid function.
        """
