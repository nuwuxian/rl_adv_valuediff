...
class ProduceActions(object):
    """
    22 produce macro actions: produce a certain type of units. each macro action contains hard-coded unit actions.
    Do not need place (placer()).
    """
    ...
    def _is_valid_produce_unit(self, type_id):
        ...
        def is_valid(dc):
            ...
            overquota = current_num >= MAXIMUM_NUM[type_id] if type_id in MAXIMUM_NUM else False
