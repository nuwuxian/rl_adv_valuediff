...
FLAGS = flags.FLAGS
flags.DEFINE_enum("job_name", 'learner', ['actor', 'learner', 'eval', 'eval_model'],
                  "Job type.")
...
flags.DEFINE_string("opp_model_path", '/home/xkw5132/wuxian/starcraft2/rl_newloss/StarCraftII/ppo_agents/checkpoint-100000', \
                    "Opponent Model Path")
...
def create_selfplay_env(random_seed=None):
  env = SC2SelfplayRawEnv(map_name='Flat32',
                          step_mul=FLAGS.step_mul,
                          resolution=16,
                          agent_race='zerg',
                          opponent_race='zerg',
